...
// Add Shortcode
function aione_vertical_carousel_shortcode( $atts ) {

	// Original Attributes, for filters
	$original_atts = $atts;
	$vcarousel_id = rand(111111, 999999);
	...
	$atts = shortcode_atts( array(
		...
		'taxonomy'            => false,
		'wrapper'             => 'div',
		'wrapper_class'       => 'vcarousel',
		'wrapper_id'          => 'vcarousel-'.$vcarousel_id,
	), $atts, 'vcarousel' );


    
        wp_register_style( 'vcarousel', plugins_url('/css/jquery.bxslider.css', __FILE__), false, '1.0.0', 'all');
        wp_enqueue_style('vcarousel');
        wp_register_script( 'vcarousel', plugins_url('/js/jquery.bxslider.min.js', __FILE__), array('jquery'), '1.0.0' );
        wp_enqueue_script('vcarousel');
	...
	$return .= "
	    <script type='text/javascript'>
	        jQuery(document).ready(function(){
	            jQuery('#vcarousel-".$vcarousel_id."').bxSlider({
	                mode: 'vertical',
	                speed:1000,
	                slideMargin:5,
	                ...
	                //startSlide:0,
	                //randomStart:false,
	                slideSelector:'div.listing-item',
	                infiniteLoop:true,
...
add_shortcode( 'vertical-carousel', 'aione_vertical_carousel_shortcode' );
